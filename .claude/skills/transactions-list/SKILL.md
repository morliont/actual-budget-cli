...
description: Fetch transactions with optional account/date/limit filters using stable machine-readable output. Use for transaction retrieval, filtering, and downstream analysis pipelines.
---
