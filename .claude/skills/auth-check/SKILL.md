---
name: auth-check
description: Validate saved Actual CLI credentials/connectivity without mutating local config. Use when orchestration needs a preflight auth/session check before running read intents.
---
