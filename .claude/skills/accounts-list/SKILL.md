---
name: accounts-list
description: Fetch all accounts from the configured Actual budget in deterministic agent-json form. Use for account discovery, id resolution, and account metadata lookups.
---
